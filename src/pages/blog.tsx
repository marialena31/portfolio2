...
const BlogPage: React.FC<PageProps<any>> = ({ data }) => {
  ...
  return (
    <Layout>
      <SEO
        title="Blog Magento, e-commerce, pilotage projet"
        pageName="blog"
        description="Retrouvez mes conseils, retours d'expérience et bonnes pratiques pour réussir vos projets e-commerce, Magento, pilotage offshore et transformation digitale."
      />
