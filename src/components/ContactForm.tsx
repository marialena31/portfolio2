...
const ContactForm: React.FC = () => {
  ...
  return (
    <section className="py-28 min-h-screen bg-gradient-to-br from-primary to-primary-dark w-full box-border">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-8 md:p-12 my-12">
